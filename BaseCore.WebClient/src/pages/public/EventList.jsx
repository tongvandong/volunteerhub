...
export default function EventList() {
  ...
  useEffect(() => {
    eventCategoryApi
      ...
      .catch((err) =>
        console.error("[EventList] load categories failed:", err),
      );
    skillApi
      .getAll()
  ...
  useEffect(() => {
    ...
    eventApi
      ...
      .catch((err) =>
        console.error("[EventList] load recommended failed:", err),
      )
  ...
  useEffect(() => {
    ...
    const params = Object.fromEntries(
      Object.entries(filters).filter(
        ([k, v]) => v !== "" && k !== "page" && k !== "pageSize",
      ),
    );
    eventApi
      .getAll({ ...params, page: 1, pageSize: 500 })
  ...
  const handleLocateMe = () => {
    ...
    if (!navigator.geolocation) {
      setGeoNote(
        "Trình duyệt không hỗ trợ định vị — đang hiển thị bản đồ tổng quan.",
      );
      return;
    }
    setLocating(true);
  ...
  return (
    <div style={{ background: "var(--c-canvas)", minHeight: "100vh" }}>
      ...
      <div style={{ position: "relative", height: 200, overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to top, rgba(36,25,15,0.72) 0%, rgba(36,25,15,0.12) 60%, transparent 100%)",
          }}
        />
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0 }}>
          <div
            style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px 22px" }}
          >
            <span
              className="inline-flex items-center gap-2 text-[12.5px] font-semibold uppercase"
              style={{ letterSpacing: "0.04em", color: "#ffd9c9" }}
            >
              <span
            ...
            >
              {loading ? (
                ...
                <>
                  <b>{totalCount}</b> sự kiện đang mở đăng ký
                </>
              )}
            </p>
          </div>
        ...
        <div style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px" }}>
          ...
          >
            ...
            >
              {radiusEvents != null ? (
                <>
                  <b style={{ color: "#059669" }}>{radiusEvents.length}</b> /{" "}
                  {radiusKm} km
                </>
              ) : loading ? (
                "…"
          ...
          {filterOpen && (
            <div
              style={{
                ...
                alignItems: "center",
                padding: "8px 0 12px",
                borderTop: "1px solid rgba(15,15,15,0.07)",
              }}
            >
              {/* Skill */}
              <select
      ...
      ══════════════════════════════════════════════════════════ */}
      <div
        style={{ maxWidth: 1152, margin: "0 auto", padding: "32px 24px 64px" }}
      >
        {/* Geo note banner */}
        {geoNote && (
          <div
          ...
          >
            <i
              ...
              style={{ color: "#d97706", fontSize: 13, flexShrink: 0 }}
            />
        ...
        {radiusEvents != null && (
          ...
          >
            <i
              ...
              style={{ color: "#059669", fontSize: 13, flexShrink: 0 }}
            />
            <span style={{ fontSize: 13, color: "#065f46" }}>
              Đang lọc sự kiện trong bán kính <b>{radiusKm} km</b> từ vị trí của
              bạn —&nbsp;
